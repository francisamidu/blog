...
<p className="font-bold">`[slug] page returning 404 when trying to access an article`.</p> 
...
```
2. <p className="font-bold">`SyntaxError: unknown: Unterminated JSX contents. (23:16)`.</p> 
